...
def uploadBatch():
	...
	'StandardNames': '0', 'Select': 'L_ListingID, L_AskingPrice, L_Address, LM_Int1_6, LM_int4_36, L_NumAcres, LM_Char10_30, LFD_WaterHeater_36, L_Zip, LM_Int4_16, LFD_Water_35', 
	...
	for listing in dataSet:
		insertStatement = "INSERT IGNORE INTO mlsdata (listingid, price, acreage, beds, baths, address, zipcode, currentheater, greenreport, sqft, water) VALUES (" + str(listing['L_ListingID']) + "," + str(listing['L_AskingPrice']) + "," + str(listing['L_NumAcres']) + "," + str(listing['LM_Int1_6'])  + "," + str(listing['LM_int4_36']) + ",'" + str(listing['L_Address']) + "'," + str(listing['L_Zip']) + ",'" + str(listing['LFD_WaterHeater_36']) + "','" + str(listing['LM_Char10_30']) + "','" + str(listing['LM_Int4_16']) + "','" + str(listing['LFD_Water_35']) +  "')"
