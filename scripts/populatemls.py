...
for listing in dataSet:
	...
	insertStatement = "INSERT INTO mlsdata (listingid, price, acreage, beds, baths, address, zipcode, currentheater, greenreport) VALUES (" + str(listing['L_ListingID']) + "," + str(listing['L_AskingPrice']) + "," + str(listing['L_NumAcres']) + "," + str(listing['LM_Int1_6'])  + "," + str(listing['LM_int4_36']) + ",'" + str(listing['L_Address']) + "'," + str(listing['L_Zip']) + ",'" + str(listing['LFD_WaterHeater_36']) + "','" + str(listing['LM_Char10_30']) + "')"
